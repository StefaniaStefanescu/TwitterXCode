   ...
   // @Environment(\.presentationMode) var presentationMode
    ...
    var body: some View {
        VStack{
           ...
           AuthHeaderView(big_title: "We're almost done!", little_title: "Let's complete some information.")
            
            VStack(spacing: 40) {
                CustomImputField(image: "rectangle.and.pencil.and.ellipsis", placeholderText: "description", text: $description)
                CustomImputField(image: "rectangle.and.pencil.and.ellipsis", placeholderText: "location", text: $location)
                CustomImputField(image: "rectangle.and.pencil.and.ellipsis", placeholderText: "link", text: $link)
